 ...
 * @package polls
 */
class pollsConnectorRequest extends modConnectorResponse {

	function __construct(Polls &$polls, array $config = array()) {
		parent::__construct($polls->modx, $config);
		$this->polls =& $polls;
	...
	public function handle($action = '') {
		...
		$path = $this->polls->config['processorsPath'].strtolower($action).'.php';
